...
const SELECT_CLS = `w-full px-4 py-3.5 text-sm border-[1.5px] border-slate-600 rounded-xl bg-slate-800 text-slate-100 font-medium
...
const INPUT_CLS = `px-4 py-3.5 text-sm border-[1.5px] border-slate-600 rounded-xl bg-slate-800 text-slate-100 font-medium
  hover:border-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all`
  ...
  return (
    <div className="animate-stepIn">
      <div className="mb-8">
        ...
        <h2 className="font-display text-3xl font-black text-slate-100 tracking-tight mb-2">Situation du foyer fiscal</h2>
        <p className="text-[14.5px] text-slate-400 leading-relaxed max-w-md">Permet de calculer précisément l&apos;IR avec le quotient familial 2025.</p>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-700/50 rounded-2xl p-7 mb-5">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <div className="text-sm font-bold text-slate-100">Situation familiale</div>
            <div className="text-[11.5px] text-slate-500">Pour le calcul du quotient familial</div>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
          <div className="flex flex-col gap-2">
            <Label className="text-sm font-medium text-slate-300">Situation matrimoniale</Label>
            <select
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-sm font-medium text-slate-300">Enfants à charge</Label>
            <select
        ...
        {/* Récap parts */}
        <div className="bg-blue-500/10 border border-blue-500/25 rounded-xl p-4 flex items-center gap-4 mb-5">
          <div className="font-display text-3xl font-black text-blue-400 flex-shrink-0">{partsStr}</div>
          <div>
            <div className="text-[13px] font-bold text-slate-100">parts fiscales</div>
        ...
        <div className="flex flex-col gap-2">
          <Label className="text-sm font-medium text-slate-300">Autres revenus du foyer (€/an)</Label>
          <input
            type="number"
            ...
            className={INPUT_CLS}
          />
          <p className="text-[11.5px] text-slate-500 leading-relaxed">Salaire conjoint, revenus fonciers, autres revenus imposables</p>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-700/50 rounded-2xl p-7 mb-5">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <div className="text-sm font-bold text-slate-100">Plan d&apos;Épargne Retraite (PER)</div>
            <div className="text-[11.5px] text-slate-500">Optimisation fiscale sur la retraite</div>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-2">
            <Label className="text-sm font-medium text-slate-300">Versements PER actifs ?</Label>
            <select
          ...
          {params.perActif === 'oui' && (
            <div className="flex flex-col gap-2">
              <Label className="text-sm font-medium text-slate-300">Montant annuel PER (€)</Label>
              <input
                type="number"
        ...
        <p className="text-[12px] text-slate-500 mt-3 leading-relaxed">
          Plafond 2025 : 10% du revenu professionnel, max 35&nbsp;194&nbsp;€ — votre plafond estimé : <strong className="text-slate-300">{fmt(perPlafond)}</strong>.
          {params.perActif === 'oui' && ' Le versement PER est déduit de la base imposable IR.'}
        </p>
      </div>

      <div className="bg-blue-500/10 border border-blue-500/25 rounded-2xl p-5 mb-6">
        <div className="flex gap-3 text-[13px] text-blue-300 leading-relaxed">
